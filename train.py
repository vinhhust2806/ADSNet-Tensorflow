...
def set_args():
  ...
  parse.add_argument('--test_name', type = str, default = 'kvasir', help = 'name of test data')
  ...
  parse.add_argument('--decoder_name', type = str, default = 'partial_decoder', help = 'choose type of decoder')
